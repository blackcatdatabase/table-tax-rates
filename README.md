...
| Pkg folder | [packages/tax-rates](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/tax-rates) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package tax-rates -Apply
