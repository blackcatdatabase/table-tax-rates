...
- Pkg folder: [packages\tax-rates](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\tax-rates)
...
graph LR
  ...
  tax_rates["tax_rates"]:::center
  tax_rates -->|FK| countries["countries"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package tax-rates -Apply
