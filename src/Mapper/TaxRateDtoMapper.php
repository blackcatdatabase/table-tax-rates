...
namespace BlackCat\Database\Packages\TaxRates\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO TaxRateDto:
...
final class TaxRateDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'country_iso2' => 'countryIso2', 'category' => 'category', 'rate' => 'rate', 'valid_from' => 'validFrom', 'valid_to' => 'validTo', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
    ...
    /** @var string[] */
    private const FLOAT_COLS  = [ 'rate' ];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'valid_from', 'valid_to', 'created_at', 'updated_at' ];
    /** @var string[] */
     ...
     * @return TaxRateDto
     */
    public static function fromRow(array $row): TaxRateDto
    {
        /** @var TaxRateDto */
    ...
    public static function fromRowOrNull(?array $row): ?TaxRateDto
    {
     ...
     *
     * @param TaxRateDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(TaxRateDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(TaxRateDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(TaxRateDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,TaxRateDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,TaxRateDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(TaxRateDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,TaxRateDto>
     */
