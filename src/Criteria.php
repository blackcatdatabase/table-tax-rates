 ...
 * - whitelist LIKE:   [ 'country_iso2', 'category' ]
 * Podporované tvary:
...
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        $allowed = array_fill_keys([ 'id', 'country_iso2', 'category', 'rate', 'valid_from', 'valid_to' ], true);
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'country_iso2', 'category', 'rate', 'valid_from', 'valid_to' ], true);
            $parts = [];
