...
final class Criteria extends BaseCriteria
{
    ...
    {
        $x = [ 'id', 'country_iso2', 'category', 'rate', 'valid_from', 'valid_to' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\TaxRates\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\TaxRates\Definitions::softDeleteColumn();
