...
final class TaxRatesModule implements ModuleInterface
{
    public function name(): string { return 'table-tax_rates'; }
    public function table(): string { return 'tax_rates'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-countries' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'ux_tax_rates_country_cat_from' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_tax_rates_country' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'ux_tax_rates_country_cat_from' ],
            'foreignKeys' => [ 'fk_tax_rates_country' ],
        ];
    }
}
