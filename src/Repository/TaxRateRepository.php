...
final class TaxRateRepository implements RepoContract {
    ...
    public function insert(array $row): void {
        ...
        $tblEsc  = $isMysql ? '`tax_rates`' : '"tax_rates"';
     ...
     * [ 'country_iso2', 'category', 'valid_from' ] = unikátní klíče (sloupce) pro konflikty,
     * [ 'rate', 'valid_to' ] = které sloupce aktualizovat.
     */
